...
The images are generated by a small Python script (`scripts/generate-cover.py`) using
[Pillow](https://python-pillow.org) and the same brand fonts as the site. The layout:
