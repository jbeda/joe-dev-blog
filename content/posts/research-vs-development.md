...
The open question is what happens as the boundary keeps moving. If the constraint is now "what should we build" rather than "can we build it," then the skill that compounds is the one that was always the hardest to teach and the slowest to automate: taste, decomposition, and knowing what good looks like before anyone's written the test. I don't think that one automates away. But I've been wrong about the pace of this before.
